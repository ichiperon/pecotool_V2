...
Write-Host "[4/6] latest.json 生成: $latestPath"

# --- 5. GitHub Release 公開 (配布リポジトリ) -------------------------------
Write-Host "[5/6] $DIST_REPO に Release v$version を公開..."
...
Write-Host "[6/6] dist-bin へコピー完了"
