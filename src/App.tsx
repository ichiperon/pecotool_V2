...
function App() {
  ...
  const { handleOpen, handleSave, executeSaveAs, handleSaveTo, previewOcrOffset, saveAllPagesWithOffset, isSavingRef: fileOpsIsSavingRef } = useFileOperations(
  ...
  return (
    ...
    >
      ...
      {showOcrSettings && (
        <Suspense fallback={null}>
          <OcrSettingsModal onClose={() => setShowOcrSettings(false)} onPreview={previewOcrOffset} onSaveAllPages={saveAllPagesWithOffset} />
        </Suspense>
      )}
