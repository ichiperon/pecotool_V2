...
import { formatFileSize } from '../utils/format'; // #336: remove duplicate local definition
...
export function SaveDialog({
  ...
  return (
    <Modal
      onClose={onCancel}
      titleId={titleId}
      backdropClassName="save-dialog-backdrop"
      dialogClassName="save-dialog"
    >
      <div className="save-dialog-header">
        <h3 id={titleId}>別名で保存</h3>
        <button onClick={onCancel} className="close-btn" title="閉じる" aria-label="閉じる">
          <X size={18} />
        </button>
      </div>
